...
class I : public InstructionFormat{
    ...
    protected:
        enum class func3_t : uint8_t {
            kaddi = 0b000,
            kslti = 0b010, // boolean, true is rs1 < imm (signextended) considering both as signed numbers
            ksltiu = 0b011, // boolean, true is rs1 < imm (unsigned) considering both as unsigned integer
            kxori = 0b100,
            kori = 0b110,
            kandi = 0b111,
            kslli = 0b001,
